"""
Initial condition generators for an isolated galaxy.
...
def _hernquist_sample(n: int, a: float, rng: np.random.Generator) -> np.ndarray:
    """Sample 3-D positions from a Hernquist density profile."""
...
def generate_galaxy_ic(
    ...
    """Return positions (N,3), velocities (N,3), masses (N,) in code units."""
    ...
    M_total = params.galaxy_mass          # 1e10 Msun
